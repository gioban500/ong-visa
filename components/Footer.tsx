    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* À propos */}
          <div>
            <h3 className="text-white font-bold text-lg mb-4">ONG VISA</h3>
            <p className="text-sm leading-relaxed mb-4">
              Dédiée à la sensibilisation et à la prévention du cancer. Ensemble,
              nous luttons pour un avenir sans cancer.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/cancers" className="hover:text-pink-500 transition-colors">
                  Cancers Féminins
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/legal" className="hover:text-pink-500 transition-colors">
                  Mentions Légales
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-sm">
          <p>
            &copy; {new Date().getFullYear()} ONG VISA. Tous droits réservés.
          </p>
          <p className="mt-2 text-gray-500">
            Les informations fournies sur ce site ne remplacent pas un avis médical
            professionnel.
          </p>
        </div>
      </div>
